...
also uses openCV to create hight contour (set bei the lines amout). Then those
...
public:
  ...
  ofxFloatSlider colorR, colorG, colorB, clightR, clightG, clightB;
  ofxFloatSlider noiseA, noiseB, camFov, camRatio;
  ...
  ofMesh lineMesh;
  vector<ofPath> mapCurves;

  ofxButton convertMap;
  ofDirectory dir;
  string shaderfile;
